...
class Order extends Model
{
    ...
    protected $fillable = ['order_no', 'visit_id', 'outlet_id', 'agent_id', 'status', 'payment_method', 'payment_status', 'fulfillment_type', 'is_storefront_order', 'subtotal', 'discount_total', 'shipping_fee', 'total'];
